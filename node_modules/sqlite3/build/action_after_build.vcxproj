...
<Project DefaultTargets="Build" ToolsVersion="4.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{5D485F62-BF2C-8FC4-35A9-882B417821FB}</ProjectGuid>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\node_sqlite3.node">
      ...
      <Command>call mkdir &quot;..\lib&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)node_sqlite3.node&quot; &quot;..\lib\node_sqlite3.node&quot;</Command>
      <Message>Copying $(OutDir)/node_sqlite3.node to ./lib/node_sqlite3.node</Message>
      <Outputs>..\lib\node_sqlite3.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="node_sqlite3.vcxproj">
      <Project>{1668A525-3C88-43A3-276D-B89800EDDC91}</Project>
